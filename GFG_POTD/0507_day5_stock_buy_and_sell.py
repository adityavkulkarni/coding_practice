...
The cost of stock on each day is given in an array price[] of size n. Each day 
you may decide to either buy or sell the stock i at price[i], you can even buy 
and sell the stock on the same day, Find the maximum profit which you can get.
...
0 <= price[i] <= 104
"""
def stockBuyAndSell(n, prices) -> int:
    profit = 0
    for i in range(1, n):
...
if __name__ == "__main__":
     print(stockBuyAndSell(n=7, prices=[100, 180, 260, 310, 40, 535, 695]))